...
class Stand extends Model
{
     ...
     */
    public function booking_company()
    {
        return $this->belongsTo('App\BookingCompany');
    }
    ...
    */
    ...
    {
        return static::where('event_id', '=', $event_id)->with('booking_company')->with('event')->get();
    }
    ...
    */
    ...
    {
        $this->reserved = true;
        $this->booking_company()->associate($company);
        $this->save();
    }
}
